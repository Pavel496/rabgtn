...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 1, 'title' => 'schedule_access',],
            ['id' => 2, 'title' => 'schedule_create',],
            ['id' => 3, 'title' => 'schedule_edit',],
            ['id' => 4, 'title' => 'schedule_view',],
            ['id' => 5, 'title' => 'schedule_delete',],
            ...
            ['id' => 22, 'title' => 'vacancy_access',],
            ['id' => 23, 'title' => 'vacancy_create',],
            ['id' => 24, 'title' => 'vacancy_edit',],
            ['id' => 25, 'title' => 'vacancy_view',],
            ['id' => 26, 'title' => 'vacancy_delete',],
            ['id' => 27, 'title' => 'sphere_access',],
            ['id' => 28, 'title' => 'sphere_create',],
            ['id' => 29, 'title' => 'sphere_edit',],
            ['id' => 30, 'title' => 'sphere_view',],
            ['id' => 31, 'title' => 'sphere_delete',],
